...
public sealed class ChromeDetailTests
{
    ...
    [Fact]
    public void TheComposerSaysHowToSend()
    {
        // Ctrl+Enter is not a binding anyone guesses, and the box is the only place to say it.
        var app = new BanterChatApp(new ChatViewModel());

        Assert.Contains("Ctrl+Enter", app.Html);
    }
